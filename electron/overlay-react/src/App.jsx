...
const YJS_WS_ENDPOINT = "wss://yjs-test.onrender.com";
const YJS_ROOM = "demo-room";
...
function App() {
  ...
  useEffect(() => {
    ...
    // Ensure provider exposes the doc (CollaborationCursor relies on this in some builds)
    if (!provider.doc) {
      provider.doc = ydoc;
    }
